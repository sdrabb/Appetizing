...
class BookingChoice extends Component {
    ...
    goToUserReservation(){
      this.props.setVariableReservationInfo(this.formatDate(this.state.date),this.state.reservationName,this.props.counterState.Ncustomers,this.state.options[this.state.selectedIndex]);
          ...
          <Container>
            ...
            <Footer theme={appetizingTheme}>
              ...
              <View style={styles.book}>
                <Button onPress={ () => { this.goToUserReservation() } }>
...
export default connect(mapStateToProps, mapDispatchToProps)(BookingChoice);
