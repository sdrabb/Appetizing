...
export default {
    ...
    // Font
    fontFamily: (Platform.OS === 'ios' ) ? 'HelveticaNeue' : 'Skia',
    fontSizeBase: 15,
    ...
    // Footer
    footerHeight: 55,
    footerDefaultBg: (Platform.OS === 'ios' ) ? '#F8F8F8' : '#fefefeff',
    ...
    toolbarDefaultBg: (Platform.OS === 'ios' ) ? '#F8F8F8' : '#e60000',
